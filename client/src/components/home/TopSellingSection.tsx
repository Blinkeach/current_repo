    ...
    <section className="py-4 sm:py-6 md:py-8 px-3 sm:px-4 md:px-6 max-w-7xl mx-auto">
      <div className="flex justify-between items-center mb-4 sm:mb-6">
        <div className="flex items-center">
          <div className="p-1.5 sm:p-2 rounded-md mr-2 sm:mr-3 bg-blue-50">
          ...
          <div>
            <h2 className="text-base sm:text-lg md:text-xl font-bold text-gray-900 flex items-center">
              <span className="hidden xs:inline">Top Selling Products</span>
              <span className="xs:hidden">Top Selling</span>
              <div className="h-0.5 sm:h-1 w-8 sm:w-10 ml-2 sm:ml-3 rounded-full bg-blue-500"></div>
            </h2>
          </div>
        </div>
