...
const AppDownloadBanner: React.FC = () => {
  return (
    <section className="py-4 sm:py-6 md:py-8 px-3 sm:px-4 md:px-6 max-w-7xl mx-auto">
      <div className="bg-gradient-to-r from-secondary to-secondary-dark rounded-lg overflow-hidden shadow-lg">
        <div className="flex flex-col md:flex-row items-center p-4 sm:p-6 md:p-8">
          <div className="md:w-2/3 text-white mb-4 sm:mb-6 md:mb-0 md:pr-6">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2 sm:mb-3">Shop On the Go!</h2>
            <p className="text-white/90 mb-3 sm:mb-4 text-sm sm:text-base leading-relaxed">
            ...
            <div className="flex flex-col xs:flex-row flex-wrap gap-2 sm:gap-3">
              <a 
                href="#" 
                className="bg-black rounded-md px-3 sm:px-4 py-2 inline-flex items-center hover:bg-gray-900 transition-colors duration-300 hover:scale-105 transform"
                aria-label="Download on the App Store"
              >
                <svg className="w-5 h-5 sm:w-6 sm:h-6 mr-2 flex-shrink-0" viewBox="0 0 24 24" fill="white">
