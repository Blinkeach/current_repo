...
console.log('🔍 Testing Cloudflare R2 with Path-Style Addressing...\n');
...
// Use path-style addressing to avoid bucket name in hostname
const r2Client = new S3Client({
  ...
  forcePathStyle: true, // This is the key fix!
});
...
async function testConnection() {
  try {
    ...
    } else if (error.code === 'InvalidAccessKeyId' || error.$metadata?.httpStatusCode === 403) {
      console.log('💡 Authentication Error:');
      console.log('   Your R2 credentials are incorrect.');
      console.log('   Please verify:');
      console.log('   1. R2_ACCESS_KEY_ID');
      console.log('   2. R2_SECRET_ACCESS_KEY');
      console.log('   In your Cloudflare R2 dashboard.\n');
